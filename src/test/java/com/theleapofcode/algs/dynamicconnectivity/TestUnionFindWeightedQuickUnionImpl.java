...
public class TestUnionFindWeightedQuickUnionImpl {

	private UnionFind uf = new UnionFindWeightedQuickUnionImpl(10);
	...
	public void testUnion() {
		...
		uf.union(6, 5);
		uf.union(9, 4);
		Assert.assertEquals("[0, 1, 2, 3, 3, 5, 5, 7, 3, 3]", uf.toString());
	}
