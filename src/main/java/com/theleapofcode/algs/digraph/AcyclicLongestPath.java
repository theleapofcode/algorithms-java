...
/**
 * The {@code AcyclicLongestPath} class represents a data type for solving the
 ...
 * {@code distTo()} and {@code hasPathTo()} methods take constant time and the
 * {@code pathTo()} method takes time proportional to the number of edges in the
 * longest path returned.
 */
