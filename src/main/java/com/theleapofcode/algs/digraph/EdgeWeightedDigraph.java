...
public class EdgeWeightedDigraph {
	...
	public EdgeWeightedDigraph(int V) {
		...
		adj = (BagLinkedListImpl<DirectedEdge>[]) new BagLinkedListImpl[V];
		for (int v = 0; v < V; v++)
	...
	public EdgeWeightedDigraph(EdgeWeightedDigraph G) {
		...
		for (int v = 0; v < G.V(); v++) {
			...
			Stack<DirectedEdge> reverse = new StackLinkedListImpl<>();
	...
	public Iterable<DirectedEdge> edges() {
		Bag<DirectedEdge> list = new BagLinkedListImpl<>();
		for (int v = 0; v < V; v++) {
