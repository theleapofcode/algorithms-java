...
public class Particle {
	 ...
	 */
	public Particle() {
		rx = RandomUtil.uniform(0.0, 1.0);
		ry = RandomUtil.uniform(0.0, 1.0);
		vx = RandomUtil.uniform(-0.005, 0.005);
		vy = RandomUtil.uniform(-0.005, 0.005);
		radius = 0.01;
		mass = 0.5;
		color = Color.BLACK;
	}
	 ...
	 */
	public void draw() {
		DrawingUtil.setPenColor(color);
		DrawingUtil.filledCircle(rx, ry, radius);
	}
