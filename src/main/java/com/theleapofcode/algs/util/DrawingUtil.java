...
public final class DrawingUtil implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static DrawingUtil std = new DrawingUtil();
	 ...
	 * <p>
	 * The predefined pen colors are {@code DrawingUtil.BLACK},
	 * {@code DrawingUtil.BLUE}, {@code DrawingUtil.CYAN},
	 * {@code DrawingUtil.DARK_GRAY}, {@code DrawingUtil.GRAY},
	 * {@code DrawingUtil.GREEN}, {@code DrawingUtil.LIGHT_GRAY},
	 * {@code DrawingUtil.MAGENTA}, {@code DrawingUtil.ORANGE},
	 * {@code DrawingUtil.PINK}, {@code DrawingUtil.RED},
	 * {@code DrawingUtil.WHITE}, and {@code DrawingUtil.YELLOW}.
	 *
	 * @param color
	...
	private static Image getImage(String filename) {
		...
		// in case file is inside a .jar (classpath relative to DrawingUtil)
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = DrawingUtil.class.getResource(filename);
			if (url != null)
				icon = new ImageIcon(url);
		}
	 ...
	 * ignore }
	 * 
	 * // in case file is inside a .jar (classpath relative to DrawingUtil) try
	 * { URL url = DrawingUtil.class.getResource(filename); BufferedImage image
	 ...
	 * { URL url = DrawingUtil.class.getResource("/" + filename); BufferedImage
	 * image = ImageIO.read(url); return image; } catch (IOException e) { //
	...
	public void actionPerformed(ActionEvent e) {
		FileDialog chooser = new FileDialog(DrawingUtil.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
		chooser.setVisible(true);
		String filename = chooser.getFile();
		if (filename != null) {
			DrawingUtil.save(chooser.getDirectory() + File.separator + chooser.getFile());
		}
	}
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			mouseX = DrawingUtil.userX(e.getX());
			mouseY = DrawingUtil.userY(e.getY());
			mousePressed = true;
		}
	}
